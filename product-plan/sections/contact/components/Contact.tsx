...
export function Contact({ contact, onSubmit }: ContactProps) {
  ...
  return (
    <section className="relative py-24 lg:py-32 overflow-hidden bg-slate-50 dark:bg-slate-950">
      ...
      <div className="relative z-10 max-w-2xl mx-auto px-6 lg:px-8">
        ...
        {showSuccess && (
          <div className="mb-8 p-4 rounded-xl bg-green-50 dark:bg-green-500/10 border border-green-200 dark:border-green-500/20 flex items-center gap-3 animate-in fade-in slide-in-from-top-2 duration-300">
        ...
        <div className="relative">
          ...
          >
            ...
            <button
              ...
              className="w-full py-4 px-6 rounded-xl font-semibold text-white transition-all duration-200 disabled:opacity-70 disabled:cursor-not-allowed"
              style={{
              ...
              onMouseEnter={(e) => {
                if (!isSubmitting) {
                  ...
                  e.currentTarget.style.boxShadow = '0 15px 30px -5px rgba(59, 130, 246, 0.35)'
                }
              }}
              onMouseLeave={(e) => {
